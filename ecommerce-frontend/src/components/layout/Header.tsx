          ...
          <div className='flex items-center justify-between gap-x-3 sm:gap-x-4 text-[16px] font-[700]'>
            <div className='flex items-center justify-between sm:gap-x-5'>
              <NavLink to={'/cart-page'} className={'flex'}>
                ...
                <span className='relative flex items-center justify-center w-5 h-5 rounded-full bg-[#fe784f] text-[#f8f7f4] text-[14px] font-[500] -top-2 right-3'>{getTotalCartItems()}</span>
              </NavLink>
              <NavLink to={'/login'} className={'ring-1 ring-[#fe784f]  bg-[#fe784f] px-7 py-[10px] text-white transition-all hover:bg-[#222222] hover:ring-[#222222] flex items-center justify-center gap-x-2 text-[16px] font-[500] rounded-xl'}>
